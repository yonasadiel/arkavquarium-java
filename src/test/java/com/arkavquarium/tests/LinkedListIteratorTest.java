...
public class LinkedListIteratorTest {
  ...
  public void testContentConstructor() {
    ...
    assertTrue(
        "constructor should set content to arguments",
        it1.getContent() == 2
    );
    assertTrue(
        "constructor should set content to arguments",
  ...
  public void testNextPrevConstructor() {
    ...
    assertTrue(
        "constructor should set prev to null",
        it.getPrev() == null
    );
    assertTrue(
  ...
  public void testContentSetter() {
    ...
    it2.setContent(3.5);
    assertTrue(
        "setContent set content to arguments",
        it1.getContent() == 3
    );
    assertTrue(
        "setContent set content to arguments",
  ...
  public void testGetterPrev() {
    ...
    it1.setPrev(it2);
    assertSame(
        "setPrev set previous to other iterator",
        it2, it1.getPrev()
    );
  }
  ...
  public void testGetterNext() {
    ...
    it1.setNext(it2);
    assertSame(
        "setNext set next to other iterator",
        it2, it1.getNext()
    );
  }
}