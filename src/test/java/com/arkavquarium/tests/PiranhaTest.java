...
public class PiranhaTest {
  ...
  public void testPiranhaLeftAsset() {
    ...
    assertEquals(
        ...
        "src/main/resources/img/piranha_left_big.png",
        p.getAssetPath()
    );
  }
  ...
  public void testPiranhaRightAsset() {
    ...
    assertEquals(
        ...
        "src/main/resources/img/piranha_right_big.png",
        p.getAssetPath()
    );
  }
  ...
  public void testStarvingAsset() {
    ...
    assertEquals(
        ...
        "src/main/resources/img/piranha_left_big_hungry.png",
        p.getAssetPath()
    );
  }
